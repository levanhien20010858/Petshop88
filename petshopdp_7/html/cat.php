...
<body>
  <div class="wrapper">
    ...
    <div class="select-dog-cat">
      <a href="dog.php"><img src="../images/dog.jpg" alt="dog" width="50px" height="50px" /></a>
      <a href="cat.php"><img src="../images/cat.jpg" alt="cat" width="50px" height="50px" style="
    ...
    <div class="select">
      <ul id="sele">
        <li id="sos">
          <a href="../classes/cats.php?category_id=1" class="nav-link">
            <div class="sss">
        ...
        <li id="sos">
          <a href="../classes/cats.php?category_id=2" class="nav-link">
            <div class="sss">
        ...
        <li id="sos">
          <a href="../classes/cats.php?category_id=3" class="nav-link">
            <div class="sss">
        ...
        <li id="sos">
          <a href="../classes/cats.php?category_id=4" class="nav-link">
            <div class="sss">
        ...
        <li id="sos">
          <a href="../classes/cats.php?category_id=5" class="nav-link">
            <div class="sss">
        ...
        <li id="sos">
          <a href="../classes/cats.php?category_id=6" class="nav-link">
            <div class="sss">
        ...
        <li id="sos">
          <a href="../classes/cats.php?category_id=9" class="nav-link">
            <div class="sss">
        ...
        <li id="sos">
          <a href="../classes/cats.php?category_id=10" class="nav-link">
            <div class="sss">
